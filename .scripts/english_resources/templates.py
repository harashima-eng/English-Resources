"""
HTML Templates and CSS for English Resources

This module contains all HTML templates, CSS styles, and SVG icons.
"""

# SVG Icons (with proper aria-hidden for accessibility)
FOLDER_ICON_SVG = '''<svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>'''

FILE_ICON_SVG = '''<svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>'''

BOOK_ICON_SVG = '''<svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>'''

ARROW_SVG = '''<svg aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>'''

SUN_ICON = '''<svg class="sun-icon" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>'''

MOON_ICON = '''<svg class="moon-icon" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>'''

# Dark mode glow background elements
BG_GLOW_HTML = '''<div class="bg-glow"></div><div class="bg-glow-accent"></div>'''
...
# Font loading link
FONT_LINK = '''<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600&family=Noto+Sans+JP:wght@400;500;600&display=swap" rel="stylesheet">'''

# Main CSS stylesheet with Nordic design, dark mode, and responsive breakpoints
MAIN_STYLE = '''*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{
...
.bg-glow::before{content:'';position:absolute;top:-20%;left:-10%;width:50%;height:60%;background:radial-gradient(ellipse at center,rgba(160,80,32,0.12) 0%,transparent 70%);filter:blur(80px)}
.bg-glow::after{content:'';position:absolute;top:30%;right:-10%;width:45%;height:50%;background:radial-gradient(ellipse at center,rgba(122,155,168,0.10) 0%,transparent 70%);filter:blur(80px)}
.bg-glow-accent{position:fixed;bottom:-10%;left:30%;width:40%;height:45%;background:radial-gradient(ellipse at center,rgba(51,112,88,0.10) 0%,transparent 70%);filter:blur(80px);z-index:-1;pointer-events:none;opacity:0;transition:opacity 0.5s ease}
